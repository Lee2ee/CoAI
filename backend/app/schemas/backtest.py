...
class BacktestRequest(BaseModel):
    ...
    n_splits: int = 5
    monte_carlo: bool = False  # 몬테카를로 시뮬레이션 활성화
    monte_carlo_runs: int = 100  # 시뮬레이션 횟수
    quant_sizing: bool = False  # 변동성 타깃 기반 동적 포지션 사이징
...
class BacktestResponse(BaseModel):
    ...
    monte_carlo_results: Optional[dict] = None  # 몬테카를로 시뮬레이션 결과
